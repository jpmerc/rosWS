...
if(TRUE)
  set(custom_navigation_SOURCE_PREFIX /home/jp/Documents/rosWS/custom_ros/src/custom_navigation)
  set(custom_navigation_DEVEL_PREFIX /home/jp/Documents/rosWS/custom_ros/devel)
  ...
  set(custom_navigation_INSTALL_PREFIX /home/jp/Documents/rosWS/custom_ros/install)
...
if(NOT "/home/jp/Documents/rosWS/custom_ros/devel/include;/home/jp/Documents/rosWS/custom_ros/src/custom_navigation/include" STREQUAL "")
  set(custom_navigation_INCLUDE_DIRS "")
  set(absolute_include_dirs "/home/jp/Documents/rosWS/custom_ros/devel/include;/home/jp/Documents/rosWS/custom_ros/src/custom_navigation/include")
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/jp/Documents/rosWS/custom_ros/src/custom_navigation/${idir})
      set(include /home/jp/Documents/rosWS/custom_ros/src/custom_navigation/${idir})
    else()
      message(FATAL_ERROR "Project 'custom_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jp/Documents/rosWS/custom_ros/src/custom_navigation/${idir}'.  Ask the maintainer 'Jean-Philippe Mercier <jean-philippe.mercier.2@ulaval.ca>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jp/Documents/rosWS/custom_ros/devel/lib;/home/jp/Documents/rosWS/custom_ros/devel/lib;/opt/ros/groovy/lib)
...
set(depends "message_generation;roscpp;sensor_msgs;std_msgs;message_runtime")
